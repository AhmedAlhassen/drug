...
public class DrugManagementSystem extends JFrame implements ActionListener{
		...
		l1 = new JLabel("");
                ...
                JLabel lid=new JLabel("DRUG MANAGEMENT SYSTEM");
        ...
        public static void main(String[] args) {
                DrugManagementSystem window = new DrugManagementSystem();
